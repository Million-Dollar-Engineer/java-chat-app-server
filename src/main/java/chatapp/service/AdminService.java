...
public class AdminService {
    ...
    public String readUserData(String fullname, String username, String status, String sortBy,
                               String order, String startTime, String endTime)
            throws Exception {
        try {

            return repo.getUserData(fullname, username, status, sortBy, order, startTime, endTime);
        } catch (Exception e) {
            System.out.println(e);
            throw e;
        }
    ...
    public String getSpamReport(String sortBy, String order ,  String startTime, String endTime, String username) throws Exception{
        try {
            return repo.getSpamReportList(sortBy, order, startTime, endTime, username);
        } catch (Exception e) {
            System.out.println(e);
            throw e;
        }
